...
public class StreakTest {
	...
	private double lowerlimit = -1.96;//los limites de Z depende del alfa escogido(0.5) -> nivel de significaciï¿½n
	...
	public StreakTest(ArrayList<Double> list, ArrayList<Double> ordenerlist){
		...
		//se encesitan dos listas una ordenada para sacar la mediana y la otra para caï¿½cular las rachas
		calculateMedian();
	}
